...
\begin{equation}
\label{eqn2} 
	f_2 = \sum \limits_{i=0}^{n} \frac{\left| \mu_i - t_i \right|}{\sigma_i + 1}
\end{equation}
where, 
...
The raw data were processed using an automation that could analyse the data to produce the IWS.
...
\label{fig:ellip}
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[height=1.2in]{Elliptical}
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[height=1.2in]{Elliptical_Graph}
